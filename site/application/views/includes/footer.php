                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="footer-content">
                            ...
                            <p><?php echo character_limiter(strip_tags($settings->about_us), 200); ?><a href="<?php echo base_url('hakkimizda'); ?>">Daha Fazla<i class="fa fa-long-arrow-right pl-5"></i></a></p>
                    ...
                    <div class="col-md-3">
                        <div class="footer-content">
                            ...
                            <div class="separator-2"></div>
                            <ul class="list-icons">
                                <li><i class="fa fa-map-marker pr-10 text-default"></i> <?php echo strip_tags($settings->address); ?></li>
