...
class Home extends CI_Controller{
    ...
    public function index()
    {
        ...
        $viewData->testimonials = $this->testimonial_model->get_all(array('isActive' => 1), "rank ASC");
    ...
    public function portfolio_detail($url)
    {
        ...
        $viewData->portfolio_images = $this->portfolio_image_model->get_all(
            array('isActive' => 1, 'portfolio_id' => $viewData->portfolio->id), "rank ASC"
        );

        $viewData->other_portfolios = $this->portfolio_model->get_all(
            array('isActive' => 1, 'id !=' => $viewData->portfolio->id),
            "rand()",
            array('start' => 0, 'count' => 3)
        );
        $this->load->view($viewData->viewFolder, $viewData);
    ...
    public function brand_list()
    {
        ...
        $viewData->brands = $this->brand_model->get_all(array('isActive' => 1), "rank ASC");
        $this->load->view($viewData->viewFolder, $viewData);
    }
    ...
    public function video_gallery_list()
    {
        $viewData = new stdClass();
        $viewData->viewFolder       = "gallery_v";
        $viewData->subViewFolder    = "video_gallery";
        $viewData->viewName         = "list_content";
        $this->load->model('gallery_model');
        $viewData->galleries = $this->gallery_model->get_all(array('isActive' => 1, 'gallery_type' => 2), "rank ASC");
        $this->load->view($viewData->viewFolder, $viewData);
    }

    public function video_gallery($url)
    {
        $viewData = new stdClass();
        $viewData->viewFolder       = "gallery_v";
        $viewData->subViewFolder    = "video_gallery";
        ...
        $viewData->videos = $this->video_model->get_all(array('isActive' => 1, 'gallery_id' => $viewData->gallery->id), "rank ASC");
        $this->load->view($viewData->viewFolder, $viewData);
    }
    ...
    public function file_gallery_list()
    {
        $viewData = new stdClass();
        $viewData->viewFolder       = "gallery_v";
        $viewData->subViewFolder    = "file_gallery";
        $viewData->viewName         = "list_content";
        $this->load->model('gallery_model');
        $viewData->galleries = $this->gallery_model->get_all(array('isActive' => 1, 'gallery_type' => 3), "rank ASC");
        $this->load->view($viewData->viewFolder, $viewData);
    }

    public function file_gallery($url)
    {
        $viewData = new stdClass();
        $viewData->viewFolder       = "gallery_v";
        $viewData->subViewFolder    = "file_gallery";
        ...
        $viewData->files = $this->file_model->get_all(array('isActive' => 1, 'gallery_id' => $viewData->gallery->id), "rank ASC");
        $this->load->view($viewData->viewFolder, $viewData);
    }
}