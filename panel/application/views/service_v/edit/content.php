<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">Hizmet Düzenle</h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url('service/edit/'.$item->id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-1">
                            <img src="<?php echo get_media($viewFolder, $item->img_url, "350x217"); ?>" alt="<?php echo $item->img_url; ?>" class="img-responsive">
                        </div>
                    ...
                    <a href="<?php echo base_url('service'); ?>" class="btn btn-md btn-danger btn-outline">İptal</a>
                </form>
            </div>
        </div>
    </div>
