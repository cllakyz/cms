                ...
                <ul class="slides">
                    ...
                    foreach($slides as $slide){ ?>
                        <li data-transition="fadefromright" data-slotamount="default" data-masterspeed="default" data-title="<?php echo $slide->title; ?>">
                            ...
                            <!-- main image -->
                            <img src="<?php echo get_media("slide_v", $slide->img_url, "1920x650"); ?>" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
