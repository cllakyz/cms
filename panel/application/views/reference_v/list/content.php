<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Referans Listesi
            <a href="<?php echo base_url('reference/new_form'); ?>" class="btn btn-outline btn-primary btn-sm pull-right"> <i class="fa fa-plus"></i> Yeni Ekle</a>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            if(empty($items)){ ?>
                <div class="alert alert-info text-center">
                    ...
                    <p>Herhangi bir veri bulunmamaktadır. Eklemek için <a href="<?php echo base_url('reference/new_form'); ?>">tıklayınız</a></p>
                </div>
            <?php
            } else{ ?>
                <table class="table table-hover table-striped table-bordered content-table">
                    ...
                    <tbody class="sortable" data-url="<?php echo base_url('reference/sort'); ?>">
                        <?php
                        foreach($items as $item){ ?>
                            <tr id="sort-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center w100">
                                    <img width="75" src="<?php echo get_media($viewFolder, $item->img_url, "80x80"); ?>" alt="" class="img-rounded">
                                </td>
                                <td class="text-center w100">
