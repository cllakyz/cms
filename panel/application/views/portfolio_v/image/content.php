    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form data-url="<?php echo base_url('portfolio/refresh_image_list/'.$item->id); ?>" action="<?php echo base_url('portfolio/image_upload/'.$item->id); ?>" id="prd-img-dropzone" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?php echo base_url('portfolio/image_upload/'.$item->id); ?>', method: 'post'}">
