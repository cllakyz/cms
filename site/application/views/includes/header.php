                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6 col-md-3">
                                                                        <div class="divider"></div>
                                                                        <ul class="menu">
                                                                            <li class="active"><a href="index-beauty.html"><i class="fa fa-magic pr-10"></i>Beauty Center <span class="badge">v1.1</span></a></li>
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-3 hidden-sm">
                                                                ...
                                                                <img src="<?php echo base_url("assets/images");?>/section-image-3.png" alt="The Project">
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
