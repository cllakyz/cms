<div class="banner dark-translucent-bg" style="background-image:url('<?php echo base_url("panel/uploads/course_v/$course->img_url"); ?>'); background-position: 50% 21%;">
    <div class="container">
        <div class="row">
            <div class="col-md-8 text-center col-md-offset-2 pv-20">
                ...
                <div class="separator object-non-visible mt-10" data-animation-effect="fadeIn" data-effect-delay="100"></div>
                <h3 class="text-center object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100"><i class="fa fa-calendar"></i> <?php echo get_date($course->event_date); ?></h3>
            </div>
        </div>
    </div>
</div>
